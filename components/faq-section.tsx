...
const faqs = [
  {
    question: "How do I post a listing on Dwell?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Dwell charges a 3% commission only when a rental is confirmed. No listing fees, no mandatory subscription. The Pro plan at ₹3,999/month reduces the commission to 2% for multi-property owners.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Our included insurance covers material damage up to ₹4,00,000 per rental. It protects owners against accidental damage. A ₹15,000 deductible applies in case of a claim.",
  },
  {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Everything you need to know about Dwell. Have a question not listed? Contact our support.
          </p>
        </div>
