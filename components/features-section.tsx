...
const allTransactions = [
  { name: "Juhu Beach Villa", amount: "+₹2,40,000", category: "Rental received", color: "from-emerald-400 to-teal-500" },
  { name: "Bandra West Loft", amount: "+₹1,85,000", category: "Rental received", color: "from-blue-400 to-indigo-500" },
  { name: "Colaba Cozy Loft", amount: "+₹1,20,000", category: "Rental received", color: "from-amber-400 to-orange-500" },
  { name: "Alibaug Pool Villa", amount: "+₹3,50,000", category: "Rental received", color: "from-rose-400 to-pink-500" },
  { name: "Powai Hills Studio", amount: "+₹75,000", category: "Rental received", color: "from-violet-400 to-purple-500" },
  { name: "Marine Drive Penthouse", amount: "+₹1,10,000", category: "Rental received", color: "from-cyan-400 to-blue-500" },
  { name: "Karjat Country House", amount: "+₹2,80,000", category: "Rental received", color: "from-lime-400 to-green-500" },
  { name: "Worli Seaface Duplex", amount: "+₹95,000", category: "Rental received", color: "from-fuchsia-400 to-pink-500" },
]
