  ...
  return (
    <div className="relative">
      <div className="absolute -top-[20vw] left-0 right-0 w-full h-[50vw] z-0 overflow-hidden">
        <Image src="https://images.unsplash.com/photo-1513584684374-8bab748fbf90?auto=format&fit=crop&w=1920&q=80" alt="Luxury modern villa" fill className="object-cover" priority unoptimized />
        {/* Premium gradient overlay to blend sky edge into white theme */}
      ...
      <footer id="contact" className="relative z-20 border-t border-border py-16 px-6 bg-background">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              <Link href="/" className="flex items-center gap-2 mb-4">
                ...
                <span className="text-base font-medium text-foreground">Dwell</span>
              </Link>
          ...
          <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-muted-foreground">© 2026 Dwell. All rights reserved.</p>
            <p className="text-xs text-muted-foreground">Dwell Inc. - Registered real estate agent</p>
          </div>
        </div>
      </footer>
    </div>
