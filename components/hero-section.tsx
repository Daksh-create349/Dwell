...
import { MobileDemoScreen } from "./mobile-demo-screen"
        ...
        <div className="text-center mb-12">
          ...
          >
            <h1 className="font-serif text-[3.5rem] sm:text-[4.5rem] md:text-[5.5rem] lg:text-[6.5rem] xl:text-[7.5rem] 2xl:text-[8.5rem] font-normal leading-tight mb-6 w-full px-4 max-w-6xl mx-auto text-balance">
              <AnimatedText text="Peer-to-peer rentals, simplified." delay={0.3} />
            </h1>
          </div>
        </div>
          ...
          <div className="relative">
            ...
            >
              <img 
                ...
                alt="Application Dwell" 
                className="w-full h-auto relative z-10 pointer-events-none" 
              />
              <div className="absolute top-[2.2%] bottom-[2.2%] left-[4.8%] right-[4.8%] rounded-[28px] md:rounded-[34px] lg:rounded-[42px] overflow-hidden z-20 bg-slate-950">
                <MobileDemoScreen />
              </div>
            </div>
          </div>
